# Star Cluster AI Doctrine Registry Architecture v0.6
...
The v0.6 architecture adds the general **Adaptive Engage** encounter model and target-specific combat memory while preserving the accepted EW-doctrine registry lifecycle from v0.5.
