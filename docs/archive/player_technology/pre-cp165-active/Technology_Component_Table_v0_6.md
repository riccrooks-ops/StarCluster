# Technology Component Table v0.6

**Checkpoint:** 127  
**Status:** main-subsystem stabilization candidate; exact Storyboard reconciliation

The table contains **218 unique entries for 218 unique Storyboard beats**. CP127 preserves that exact architecture while synchronizing the main-subsystem numerical references to `technology_numerical_matrix_v0_4.json`. Most AUX numerical tuning remains deferred; this is still not production-runtime promotion.
