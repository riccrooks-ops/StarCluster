...
## Checkpoint 27 Phase B calibration entry

The Phase B calibration subpass begins only after the 54 Phase A cases and 36 Phase B cases pass against the revised 126-value baseline. It executes the 29-variant kinetic interaction study described in `TL1_Kinetic_Interaction_Calibration_Plan_v0_1.md`. Passing symmetry gates establishes a trustworthy study surface; it does not by itself lock balance.

## Checkpoint 28 energy calibration extension

After the accepted kinetic interaction study, run the 31-variant TL1 energy study against the unchanged SI2/AI4/Hull12 envelope. Treat the kinetic cannon as the control. Measure low, standard, and two-shot safe-overload-burst doctrines; Tactical Power use; tactical Shield recharge; EvM; computer and reactor degradation; range retention; and side-swapped cross-family outcomes. Do not infer repeated forced-overload balance until complete weapon-failure consequences exist.
