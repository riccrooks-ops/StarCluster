...
$checkpoint = Read-Json (Join-Path $repositoryRoot 'tools\calibration\checkpoints\checkpoint-53a.json')
...
Assert-True ([string]$checkpoint.checkpointId -eq '53a') 'Checkpoint definition ID mismatch.'
...
Write-Host '       Checkpoint 53a hotfix definition: 31 stages, 9,007 Monte Carlo variants, 90.07 million default trials.'
