...
OUT=ROOT/'checkpoint-58-static-preflight.txt'; checks=[]
...
required=[
 ROOT/'Checkpoint_58_Readme.txt',ROOT/'README.md',ROOT/'docs/README.md',ROOT/'docs/Prototype_TODO.md',
 ...
 ROOT/'docs/validation/Checkpoint_58_Single_Main_TL4_Subsystem_Foundation_And_Powered_Defense_Screening.md',
 ...
 ROOT/'tools/calibration/checkpoints/checkpoint-58.json',ROOT/'tools/checkpoints/checkpoint-58/apply_checkpoint_58.ps1',ROOT/'tools/checkpoints/checkpoint-58/test_technology_architecture.ps1',ROOT/'tools/checkpoints/checkpoint-58/static_preflight_checkpoint_58.py',ROOT/'tools/checkpoints/checkpoint-58/checkpoint_57a_scenario_hashes.txt',ROOT/'tools/checkpoints/checkpoint-58/checkpoint_57a_critical_hashes.txt',
...
validate_hash_list(ROOT/'tools/checkpoints/checkpoint-58/checkpoint_57a_scenario_hashes.txt',95,'frozen 57a scenario')
validate_hash_list(ROOT/'tools/checkpoints/checkpoint-58/checkpoint_57a_critical_hashes.txt',498,'frozen 57a critical')
...
lines=[f'Checkpoint 58 static preflight: {passed}/{len(checks)} checks passed; {len(failed)} failed.']
