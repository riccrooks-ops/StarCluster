...
$staticPreflight = Join-Path $PSScriptRoot 'static_preflight_checkpoint_54.py'
$harness = Join-Path $repositoryRoot 'tools\calibration\run_calibration_checkpoint.ps1'
$definition = Join-Path $repositoryRoot 'tools\calibration\checkpoints\checkpoint-54a.json'
