...
OUT=ROOT/'checkpoint-55-static-preflight.txt'
checks=[]
...
required=[
 ROOT/'README.md',ROOT/'Checkpoint_55_Readme.txt',ROOT/'docs/README.md',ROOT/'docs/Prototype_TODO.md',
 ...
 ROOT/'tools/calibration/checkpoints/checkpoint-55.json',ROOT/'tools/checkpoints/checkpoint-55/apply_checkpoint_55.ps1',ROOT/'tools/checkpoints/checkpoint-55/test_technology_architecture.ps1',ROOT/'tools/checkpoints/checkpoint-55/static_preflight_checkpoint_55.py',ROOT/'tools/checkpoints/checkpoint-55/checkpoint_54a_scenario_hashes.txt',
...
hashp=ROOT/'tools/checkpoints/checkpoint-55/checkpoint_54a_scenario_hashes.txt'; lines=[x for x in read(hashp).splitlines() if x.strip()]
...
cp=loadj(ROOT/'tools/calibration/checkpoints/checkpoint-55.json'); sids=[s['id'] for s in cp['stages']]
ok('checkpoint ID',cp['checkpointId']=='55'); ok('checkpoint manifest',cp['manifestFile']=='CHECKPOINT_55_SHA256SUMS.txt'); ok('checkpoint output',cp['outputRoot']=='out/checkpoint-55')
...
for rel in ['README.md','docs/README.md','docs/Prototype_TODO.md','docs/design/player_technology/README.md','Checkpoint_55_Readme.txt']:
    text=read(ROOT/rel); ok(f'front door CP55 {rel}','Checkpoint 55' in text); ok(f'front door v0.5b/v0.36 {rel}', rel=='docs/Prototype_TODO.md' or rel=='Checkpoint_55_Readme.txt' or ('v0.5b' in text or 'v0_36' in text or 'v0.36' in text))
...
lines=[f'Checkpoint 55 static preflight: {passed}/{len(checks)} checks passed.','']
