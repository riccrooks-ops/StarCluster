...
$checkpoint = Read-Json (Join-Path $repositoryRoot 'tools\calibration\checkpoints\checkpoint-54.json')
...
Assert-True ([string]$checkpoint.checkpointId -eq '54') 'Checkpoint definition ID mismatch.'
...
Write-Host '       Checkpoint 54 definition: 35 stages, 9,877 Monte Carlo variants, 98.77 million default trials.'
